...
import RequestCardProposition from "../components/RequestPropositionCom/RequestCardProposition";
const { width, height } = Dimensions.get("screen");

function MyRequestProposition({ navigation, route }) {
  ...
  console.log("2", status, userName, rating);
  return (
    <>
...
export default MyRequestProposition;
