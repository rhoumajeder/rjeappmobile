...
import OfferCardProposition from "../components/OfferPropositionCom/OfferCardProposition";
const { width, height } = Dimensions.get("screen");

function MyOfferProposition({ navigation, route }) {
...
export default MyOfferProposition;
